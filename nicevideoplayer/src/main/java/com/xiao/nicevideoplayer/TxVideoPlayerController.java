...
public class TxVideoPlayerController
    ...
    private static final int STRING_PREPARING = 2;
    private static final int STRING_REPLAY = 0;
    private static final int STRING_ERROR = 1;
    ...
    public TxVideoPlayerController(Context context, String listString[]) {
        super(context);
        mContext = context;
    ...
    private void init() {
        ...
        tvRetry = findViewById(R.id.replay);
        tvError.setText(listString[STRING_ERROR]);
        tvRetry.setText(listString[STRING_REPLAY]);
    ...
    protected void onPlayStateChanged(int playState) {
        switch (playState) {
            ...
            case NiceVideoPlayer.STATE_PREPARING:
                ...
                mLoadText.setText(listString[STRING_PREPARING]);
    ...
    protected void updateProgress() {
        ...
        // 更新时间
        mTime.setText(new SimpleDateFormat("HH:mm", Locale.US).format(new Date()));
    }
