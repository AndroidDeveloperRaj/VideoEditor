package com.bs.videoeditor.custom;
...
import static com.bs.videoeditor.custom.BubbleUtils.dp2px;
import static com.bs.videoeditor.custom.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMin = a.getFloat(R.styleable.BubbleSeekBar_bsb_min, 0.00f);
        mMax = a.getFloat(R.styleable.BubbleSeekBar_bsb_max, 100.00f);
